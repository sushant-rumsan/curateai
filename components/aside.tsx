    ...
    <aside className="hidden lg:block">
            <div className="border border-gray-100 rounded-lg p-4 mb-4">
              ...
              <div className="space-y-2">
                <button className="w-full py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-[14px]">
                  Connect Wallet
                </button>
            ...
            <div className="border border-gray-100 rounded-lg overflow-hidden">
              <h2 className="font-bold px-4 py-3 border-b border-gray-100">#discuss</h2>
